  ...
  static Widget buildLanguageSelector(BuildContext context) {
    return Consumer<SettingProvider>(
      builder: (context, provider, child) {
        ...
        return ListTile(
          title: AutoText(
            "Ngôn ngữ",style: TextStyle(color: selectedColor),
          ),
    ...
    return Consumer<SettingProvider>(
      builder: (context, provider, child) {
        ...
        final List<Color> colors = [
          const Color.fromARGB(255, 215, 200, 89),
        ...
        return ListTile(
          title: AutoText("Màu chủ đề", style: TextStyle(color: selectedColor),),
          subtitle: Wrap(
            spacing: 10,
            runSpacing: 12,
  ...
  static Widget buildThemeSwitch(BuildContext context) {
    return Consumer<SettingProvider>(
      builder: (context, provider, child) {
        ...
        return ListTile(
          title: AutoText("Chế độ tối", style: TextStyle(color: selectedColor),),
          trailing: Switch(
    ...
    return Consumer<SettingProvider>(
      builder: (context, provider, child) {
        ...
        if (settings.fontSize == "small") {
          ...
          fontSizeLabel = "Trung bình";
        } else {
          fontSizeLabel = "Lớn";
        }
        return ListTile(
          title: AutoText("Cỡ chữ", style: TextStyle(color: selectedColor)),
          subtitle: Slider(
